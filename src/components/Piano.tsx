...
export default function Piano({ volume }: { volume: number }) {
  ...
  return <section className="panel piano-panel">
    ...
    <div className="piano-caption"><span><span className="status-dot"/> Keyboard aktif</span><span className="hidden md:inline">Putih <b>ZXCVBNMQWERTYUIOP</b><i/> Hitam <b>DFG1234567890</b></span><Music2 size={14}/></div>
  </section>;
}
